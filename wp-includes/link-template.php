...
//    $next       = get_next_post_link( '<div class="nav-next">%link</div>', $args['next_text'] );
	$previous   = get_previous_post_link( '<div class="nav-previous"><div class="nav-indicator">' . esc_html__( 'Previous Post:', 'Previous post', 'lyndascore' ) . '</div><h1>%link</h1></div>', $args['prev_text'] );
    $next   = get_next_post_link( '<div class="nav-next"><div class="nav-indicator">' . esc_html__( 'Next Post:', 'Next post', 'lyndascore' ) . '</div><h1>%link</h1></div>', $args['next_text'] );
